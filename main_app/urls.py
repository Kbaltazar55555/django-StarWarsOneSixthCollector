...
urlpatterns = [
    ...
    path('sw/<int:sw_id>/custom/', CustomListCreate.as_view(), name='custom-list-create'), #NOT WORKING
	path('sw/<int:sw_id>/custom/<int:custom_id>/', CustomDetail.as_view(), name='Custom-detail'), #NOT WORKING
